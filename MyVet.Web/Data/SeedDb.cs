...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckPetsAsync()
        {
            ...
            {
                AddPet("Mina", owner, petType, "Labrador");
                AddPet("Lucas", owner, petType, "Dobermann");
        ...
        private async Task CheckOwnersAsync()
        {
            if (!_context.Owners.Any())
            {
                ...
                AddOwner("7655544", "Olga", "Gomez", "343 3226", "300 322 3221", "Calle 77 #22 21");
                AddOwner("6565555", "Natalia", "Jaramillo", "450 4332", "350 322 3221", "Carrera 56 #22 21");
                await _context.SaveChangesAsync();
            }
        }
